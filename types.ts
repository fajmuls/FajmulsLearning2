...
export type BenchmarkMode = 'REACTION' | 'SEQUENCE' | 'AIM' | 'CHIMP' | 'VISUAL' | 'NUMBER' | 'VERBAL' | 'TYPING' | 'BRIDGE' | 'MATCH' | 'HANGMAN' | 'HOTCOLD' | 'NUMBER_RANGE' | 'POSITION_MEMORY' | 'PATTERN_BREAKER' | 'DECISION_LAB' | 'REVERSE_THINKING' | 'LOGIC_MAZE' | 'TIME_PRESSURE' | 'MULTI_LAYER' | 'SYNONYM_ANTONYM' | 'ARTICLE_TEST';
